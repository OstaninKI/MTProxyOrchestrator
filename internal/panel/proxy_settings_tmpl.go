  ...
  <div class="col-7">
    <section class="card">
      ...
      <div class="card-body">
        ...
        <label class="setting-toggle-row"><div class="col setting-toggle-copy"><span class="setting-title">ClientHello MSS clamp</span><span class="help">Clamp TCP MSS to avoid ClientHello fragmentation.</span></div><span class="toggle"><input type="checkbox" name="mss_clamp" value="1" {{if .MSSClamp}}checked{{end}}><span class="toggle-track"><span class="toggle-thumb"></span></span></span></label>
        <label class="setting-toggle-row"><div class="col setting-toggle-copy"><span class="setting-title">Padded (dd) links</span><span class="help">Use dd-prefixed (padded) secrets in share links.</span></div><span class="toggle"><input type="checkbox" name="random_padding" value="1" {{if .RandomPadding}}checked{{end}}><span class="toggle-track"><span class="toggle-thumb"></span></span></span></label>
        <label class="setting-toggle-row"><div class="col setting-toggle-copy"><span class="setting-title">JA4 probe logging</span><span class="help">Log JA4 fingerprints of incoming probes.</span></div><span class="toggle"><input type="checkbox" name="ja4_log" value="1" {{if .JA4Log}}checked{{end}}><span class="toggle-track"><span class="toggle-thumb"></span></span></span></label>
        <div class="grid-3">
...
<div class="grid-12">
  ...
  <div class="col-5">
    ...
    <section class="card">
      ...
      <div class="card-body col col-panel">
        <div class="copy-row"><span class="val mono">{{.PanelPath}}</span><button class="btn" data-size="xs" data-variant="ghost" type="button" data-copy disabled>{{icon "Copy" 12}}</button></div>
